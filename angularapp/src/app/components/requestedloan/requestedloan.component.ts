...
export class RequestedloanComponent implements OnInit {
  ...
  columnDefs = [
    ...
    { headerName: 'User ID', field: 'UserId', filter: 'agNumberColumnFilter', flex: 1, minWidth: 120 },
    { headerName: 'Loan ID', field: 'LoanId', filter: 'agNumberColumnFilter', flex: 1, minWidth: 120 },
    { headerName: 'Farm Purpose', field: 'FarmPurpose', filter: 'agTextColumnFilter', flex: 2, minWidth: 200 },
    {
      headerName: 'Status', 
      field: 'LoanStatus', 
