...
export class UserviewloanComponent implements OnInit {
  ...
  columnDefs = [
    ...
    { headerName: 'Loan Description', field: 'Description', flex: 2 },
    { headerName: 'Interest Rate', field: 'InterestRate', flex: 1 },
    { headerName: 'Maximum Amount', field: 'MaximumAmount', flex: 1 },
    { headerName: 'Repayment Tenure (Months)', field: 'RepaymentTenure', flex: 1 },
    { headerName: 'Eligibility', field: 'Eligibility', flex: 2 },
    { headerName: 'Documents Required', field: 'DocumentsRequired', flex: 2 },
    {
      headerName: 'Action',
